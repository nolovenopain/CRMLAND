...
export default class ThemeCategory2 extends Component {
    ...
    async getThemeListCategory_2(token, page) {
        const res = await getThemeListCategory_2(
            token, 
            page, 
        );
        if(res.status == 200) {
