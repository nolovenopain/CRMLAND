...
import { removeAscent } from '../../../Helpers/RegularExpression';
...
export default class SingleSelect extends Component {
    ...
    async search(searchText) {
        if(searchText == '') {
            ...
            const filterItems = this.props.items.filter(e => removeAscent(e.name.toLowerCase()).includes(removeAscent(searchText.toLowerCase())));
            this.setState({ items: filterItems });
        } 
    }

    refreshListItems(newListItems) {
